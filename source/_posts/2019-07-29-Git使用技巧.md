...
>4. 其他命令
     ...
     //获取当前仓库下指定时间段,指定人员提交信息列表
     git log --since="2019-08-12" --before="2019-12-12" --author="yadong.hou" --pretty=tformat: --numstat | awk '{ add += $1; subs += $2; loc += $1 - $2 } END { printf "added lines: %s, removed lines: %s, total lines: %s ", add, subs, loc }'
